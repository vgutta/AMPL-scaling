...
def test():
    ...
    with open('config_delaney_fit_XGB.json') as f:
    ...
    # -----------------------------
    model_dir = 'result/delaney-processed_curated_fit/xgboost_computed_descriptors_scaffold_regression'
    ...
    with open('config_delaney_predict_XGB.json', 'r') as f:
