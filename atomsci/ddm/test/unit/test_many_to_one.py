...
def test_mto_pass():
    pass_file = tu.relative_to_file(__file__, "../test_datasets/many_to_one_pass.csv")
    mto.many_to_one(pass_file, "smiles_col", "id_col")


@pytest.mark.basic
def test_mto_fail():
    fail_file = tu.relative_to_file(__file__, "../test_datasets/many_to_one_fail.csv")
...
@pytest.mark.basic
def test_mto_nan():
    fail_file = tu.relative_to_file(__file__, "../test_datasets/many_to_one_nan.csv")
    try:
        mto.many_to_one(fail_file, "smiles_col", "id_col")
...
@pytest.mark.basic
def test_mto_nan2():
    fail_file = tu.relative_to_file(__file__, "../test_datasets/many_to_one_nan2.csv")
    try:
        mto.many_to_one(fail_file, "smiles_col", "id_col")
