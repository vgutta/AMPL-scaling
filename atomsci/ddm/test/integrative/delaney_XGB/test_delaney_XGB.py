...
def test():
    ...
    with open(tu.relative_to_file(__file__, "config_delaney_fit_XGB.json")) as f:
    ...
    model_dir = tu.relative_to_file(
        __file__,
        "result/delaney-processed_curated_fit/xgboost_computed_descriptors_scaffold_regression",
    )
    ...
    with open(
        tu.relative_to_file(__file__, "config_delaney_predict_XGB.json"), "r"
    ) as f:
