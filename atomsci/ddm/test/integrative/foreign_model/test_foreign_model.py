...
def test_without_adi():
    ...
    result = subprocess.Popen(
        [
            "python",
            tu.relative_to_file(
                __file__, "../../../examples/BSEP/predict_bsep_inhibition.py"
            ),
            "-i",
            tu.relative_to_file(
                __file__, "../../../examples/BSEP/data/small_test_data.csv"
            ),
            "-o",
            tu.relative_to_file(__file__, "small_test_output.csv"),
            "--id_col",
            "compound_name",
            "--smiles_col",
            "base_rdkit_smiles",
...
def test_with_adi():
    ...
    result = subprocess.Popen(
        [
            ...
            tu.relative_to_file(
                __file__,
                "../../../examples/BSEP/data/data/morgan_warner_combined_bsep_data.csv",
            ),
        ]
    )
    output, error = result.communicate()
