...
<<<<<<< Updated upstream:atomsci/ddm/test/integrative/delaney_RF/test_delaney_RF.py
import pdb
...
sys.path.append(os.path.join(os.path.dirname(__file__), ".."))
>>>>>>> Stashed changes:atomsci/ddm/test/integrative/delaney_RF/test_delany_RF.py
...
>>>>>>> Stashed changes:atomsci/ddm/test/integrative/delaney_RF/test_delany_RF.py
        integrative_utilities.download_save(
            ...
            tu.relative_to_file(__file__, "delaney-processed.csv"),
        )
...
def test():
    ...
    with open(tu.relative_to_file(__file__, "config_delaney_fit_RF.json")) as f:
    ...
    # -----------------------------
    model_dir = tu.relative_to_file(
        __file__,
        "result/delaney-processed_curated_fit/RF_computed_descriptors_scaffold_regression",
    )
    ...
    with open(
        tu.relative_to_file(__file__, "config_delaney_predict_RF.json"), "r"
    ) as f:
    ...
    # combined.to_csv(
    #     tu.relative_to_file(__file__, "delaney-processed_curated_predict.csv")
    # )
    # assert (
    #     os.path.isfile(
    #         tu.relative_to_file(__file__, "delaney-processed_curated_predict.csv")
