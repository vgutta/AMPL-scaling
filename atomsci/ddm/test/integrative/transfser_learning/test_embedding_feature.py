...
def test_embedded_features():
    ...
    dskey = tu.relative_to_file(__file__, "../../test_datasets/H1_hybrid.csv")
    id_col = "compound_id"
    smiles_col = "rdkit_smiles"
    response_cols = "activity"

    model_path = tu.relative_to_file(__file__, "embedding_model.tar.gz")
    result_dir = tu.relative_to_file(__file__, "test_embedding")
    ...
    pparams.result_dir = tu.relative_to_file(__file__, pparams.result_dir)
